package coriew.client.gui.widgets;
...
public class PasswordFieldWidget extends ClickableWidget implements Drawable, Element {
    ...
    public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        if (this.isVisible()) {
            ...
            string = this.textRenderer.trimToWidth(string.substring(this.firstCharacterIndex), this.getInnerWidth());
